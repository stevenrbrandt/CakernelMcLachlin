...
static void ML_BSSN_Host_convertToADMBase_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
  ...
  CCTK_LOOP3STR(ML_BSSN_Host_convertToADMBase,
    ...
    vecimin,vecimax, CCTK_REAL_VEC_SIZE)
  {
    ...
    CCTK_REAL_VEC gxxL CCTK_ATTRIBUTE_UNUSED = kmul(gt11L,e4phi);
    
    CCTK_REAL_VEC gxyL CCTK_ATTRIBUTE_UNUSED = kmul(gt12L,e4phi);
    
    CCTK_REAL_VEC gxzL CCTK_ATTRIBUTE_UNUSED = kmul(gt13L,e4phi);
    
    CCTK_REAL_VEC gyyL CCTK_ATTRIBUTE_UNUSED = kmul(gt22L,e4phi);
    
    CCTK_REAL_VEC gyzL CCTK_ATTRIBUTE_UNUSED = kmul(gt23L,e4phi);
    
    CCTK_REAL_VEC gzzL CCTK_ATTRIBUTE_UNUSED = kmul(gt33L,e4phi);
    
    CCTK_REAL_VEC kxxL CCTK_ATTRIBUTE_UNUSED = 
      kmul(e4phi,kmadd(gt11L,kmul(trKL,ToReal(0.333333333333333333333333333333)),At11L));
    
    CCTK_REAL_VEC kxyL CCTK_ATTRIBUTE_UNUSED = 
      kmul(e4phi,kmadd(gt12L,kmul(trKL,ToReal(0.333333333333333333333333333333)),At12L));
    
    CCTK_REAL_VEC kxzL CCTK_ATTRIBUTE_UNUSED = 
      kmul(e4phi,kmadd(gt13L,kmul(trKL,ToReal(0.333333333333333333333333333333)),At13L));
    
    CCTK_REAL_VEC kyyL CCTK_ATTRIBUTE_UNUSED = 
      kmul(e4phi,kmadd(gt22L,kmul(trKL,ToReal(0.333333333333333333333333333333)),At22L));
    
    CCTK_REAL_VEC kyzL CCTK_ATTRIBUTE_UNUSED = 
      kmul(e4phi,kmadd(gt23L,kmul(trKL,ToReal(0.333333333333333333333333333333)),At23L));
    
    CCTK_REAL_VEC kzzL CCTK_ATTRIBUTE_UNUSED = 
      kmul(e4phi,kmadd(gt33L,kmul(trKL,ToReal(0.333333333333333333333333333333)),At33L));
  ...
  CCTK_ENDLOOP3STR(ML_BSSN_Host_convertToADMBase);
}

extern "C" void ML_BSSN_Host_convertToADMBase(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
  ...
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Entering ML_BSSN_Host_convertToADMBase_Body");
  }
  
  if (cctk_iteration % ML_BSSN_Host_convertToADMBase_calc_every != ML_BSSN_Host_convertToADMBase_calc_offset)
  {
    return;
  }
  ...
  GenericFD_AssertGroupStorage(cctkGH, "ML_BSSN_Host_convertToADMBase", 10, groups);
  
  
  GenericFD_LoopOverEverything(cctkGH, ML_BSSN_Host_convertToADMBase_Body);
  
  if (verbose > 1)
  {
    CCTK_VInfo(CCTK_THORNSTRING,"Leaving ML_BSSN_Host_convertToADMBase_Body");
  }
}

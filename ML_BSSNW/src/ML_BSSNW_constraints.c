...
void ML_BSSNW_constraints_Body(cGH const * const cctkGH, CCTK_INT const dir, CCTK_INT const face, CCTK_REAL const normal[3], CCTK_REAL const tangentA[3], CCTK_REAL const tangentB[3], CCTK_INT const min[3], CCTK_INT const max[3], CCTK_INT const n_subblock_gfs, CCTK_REAL * const subblock_gfs[])
{
            ...
            cctk_lssh[CCTK_LSSH_IDX(0,0)],cctk_lssh[CCTK_LSSH_IDX(0,1)],cctk_lssh[CCTK_LSSH_IDX(0,2)])
  {
    ...
    CCTK_REAL const T1000146  =  invW*PDstandardNth3W;
    ...
    CCTK_REAL const T1000147  =  SQR(pdphi1);
    
    CCTK_REAL const T1000148  =  SQR(pdphi2);
    
    CCTK_REAL const T1000149  =  SQR(pdphi3);
    ...
    CCTK_REAL const T1000150  =  At12L*gtu21;
    
    CCTK_REAL const T1000151  =  At13L*gtu31;
    
    CCTK_REAL const T1000152  =  At23L*gtu32;
    
    CCTK_REAL const T1000153  =  At11L*gtu11;
    
    CCTK_REAL const T1000154  =  At22L*gtu22;
    
    CCTK_REAL const T1000155  =  At33L*gtu33;
    ...
    cdphi213  =  invW*khalf*(-PDstandardNth13W + Gt213*PDstandardNth2W + 
          Gt313*PDstandardNth3W + PDstandardNth1W*(Gt113 + T1000146));
    ...
    cdphi223  =  invW*khalf*(Gt123*PDstandardNth1W - PDstandardNth23W + 
          Gt323*PDstandardNth3W + PDstandardNth2W*(Gt223 + T1000146));
    ...
    Atm11  =  T1000150 + T1000151 + T1000153;
    
    Atm22  =  T1000150 + T1000152 + T1000154;
    
    Atm33  =  T1000151 + T1000152 + T1000155;
    ...
    M1L  =  -(At12L*Gt112*gtu22) - At11L*Gt122*gtu22 - At22L*Gt212*gtu22 - 
        ...
        At13L*Gt333*gtu33 + 6*At11L*gtu11*pdphi1 + 6*At13L*gtu31*pdphi1 + 
        gtu21*(-(At12L*Gt111) - 3*At11L*Gt112 - At22L*Gt211 - 3*At12L*Gt212 - 
           At23L*Gt311 - 3*At13L*Gt312 + 6*At12L*pdphi1) + 6*At11L*gtu21*pdphi2 + 
        6*At12L*gtu22*pdphi2 + 6*At13L*gtu32*pdphi2 + 6*At11L*gtu31*pdphi3 + 
        6*At12L*gtu32*pdphi3 + 6*At13L*gtu33*pdphi3 + gtu11*PDstandardNth1At11 + 
        gtu21*PDstandardNth1At12 + gtu31*PDstandardNth1At13 - 
        ktwothird*PDstandardNth1trK + gtu21*PDstandardNth2At11 + 
        gtu22*PDstandardNth2At12 + gtu32*PDstandardNth2At13 + 
        gtu31*PDstandardNth3At11 + gtu32*PDstandardNth3At12 + 
        gtu33*PDstandardNth3At13;
    ...
    M2L  =  -(At12L*Gt111*gtu11) - At11L*Gt112*gtu11 - At22L*Gt211*gtu11 - 
        ...
        6*At12L*gtu11*pdphi1 + 6*At22L*gtu21*pdphi1 + 6*At23L*gtu31*pdphi1 + 
        6*At12L*gtu21*pdphi2 + 6*At22L*gtu22*pdphi2 + 6*At23L*gtu32*pdphi2 + 
        6*At12L*gtu31*pdphi3 + 6*At22L*gtu32*pdphi3 + 6*At23L*gtu33*pdphi3 + 
        gtu11*PDstandardNth1At12 + gtu21*PDstandardNth1At22 + 
        gtu31*PDstandardNth1At23 + gtu21*PDstandardNth2At12 + 
        gtu22*PDstandardNth2At22 + gtu32*PDstandardNth2At23 - 
    ...
    M3L  =  -(At13L*Gt111*gtu11) - At11L*Gt113*gtu11 - At23L*Gt211*gtu11 - 
        ...
        6*At13L*gtu11*pdphi1 + 6*At23L*gtu21*pdphi1 + 6*At33L*gtu31*pdphi1 + 
        6*At13L*gtu21*pdphi2 + 6*At23L*gtu22*pdphi2 + 6*At33L*gtu32*pdphi2 + 
        6*At13L*gtu31*pdphi3 + 6*At23L*gtu32*pdphi3 + 6*At33L*gtu33*pdphi3 + 
        gtu11*PDstandardNth1At13 + gtu21*PDstandardNth1At23 + 
        gtu31*PDstandardNth1At33 + gtu21*PDstandardNth2At13 + 
        gtu22*PDstandardNth2At23 + gtu32*PDstandardNth2At33 + 
    ...
    cAL  =  2*(At12L*gtu21 + At13L*gtu31 + At23L*gtu32) + T1000153 + T1000154 + 
        T1000155;
    ...
    Rphi11  =  -2*(cdphi211 - 2*T1000147 + 
          gt11L*(cdphi233*gtu33 + 4*(gtu32*pdphi2*pdphi3 + 
                pdphi1*(gtu21*pdphi2 + gtu31*pdphi3)) + 
             gtu11*(cdphi211 + 2*T1000147) + gtu22*(cdphi222 + 2*T1000148) + 
             2*(cdphi212*gtu21 + cdphi213*gtu31 + cdphi223*gtu32 + gtu33*T1000149)));

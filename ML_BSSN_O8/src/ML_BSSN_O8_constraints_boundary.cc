...
static void ML_BSSN_O8_constraints_boundary_Body(cGH const * restrict const cctkGH, int const dir, int const face, CCTK_REAL const normal[3], CCTK_REAL const tangentA[3], CCTK_REAL const tangentB[3], int const min[3], int const max[3], int const n_subblock_gfs, CCTK_REAL * restrict const subblock_gfs[])
{
            ...
            cctk_lsh[0],cctk_lsh[1],cctk_lsh[2])
  {
    ...
    CCTK_REAL_VEC cXt1L = 0;
    
    CCTK_REAL_VEC cXt2L = 0;
    
    CCTK_REAL_VEC cXt3L = 0;
...
extern "C" void ML_BSSN_O8_constraints_boundary(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;

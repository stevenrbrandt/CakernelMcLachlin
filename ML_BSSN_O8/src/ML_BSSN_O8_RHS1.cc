...
static void ML_BSSN_O8_RHS1_Body(cGH const * restrict const cctkGH, int const dir, int const face, CCTK_REAL const normal[3], CCTK_REAL const tangentA[3], CCTK_REAL const tangentB[3], int const min[3], int const max[3], int const n_subblock_gfs, CCTK_REAL * restrict const subblock_gfs[])
{
  ...
  GenericFD_EnsureStencilFits(cctkGH, "ML_BSSN_O8_RHS1", 5, 5, 5);
    ...
    cctk_lsh[0],cctk_lsh[1],cctk_lsh[2])
  {
    ...
    CCTK_REAL phirhsL = beta1L*PDupwindNthAnti1phi + 
    ...
    CCTK_REAL gt11rhsL = -2*alphaL*At11L + 2*(gt12L*PDstandardNth1beta2 + 
    ...
    CCTK_REAL gt12rhsL = -2*alphaL*At12L + gt22L*PDstandardNth1beta2 + 
    ...
    CCTK_REAL gt13rhsL = -2*alphaL*At13L + gt23L*PDstandardNth1beta2 + 
    ...
    CCTK_REAL gt23rhsL = -2*alphaL*At23L + gt13L*PDstandardNth2beta1 + 
    ...
    CCTK_REAL gt33rhsL = -2*alphaL*At33L + 2*(gt13L*PDstandardNth3beta1 + 
    ...
    CCTK_REAL dottrK = beta1L*PDupwindNthAnti1trK + 
      ...
      Xtn2) - PDstandardNth3alpha*Xtn3) + PDupwindNthSymm1trK*Abs(beta1L) + 
    ...
    CCTK_REAL beta1rhsL = (beta1L*PDupwindNthAnti1beta1 + 
    ...
    CCTK_REAL beta2rhsL = (beta1L*PDupwindNthAnti1beta2 + 
    ...
    CCTK_REAL beta3rhsL = (beta1L*PDupwindNthAnti1beta3 + 
    ...
    CCTK_REAL B1rhsL = (beta1L*(PDupwindNthAnti1B1 - PDupwindNthAnti1Xt1) 
    ...
    CCTK_REAL B2rhsL = (beta1L*(PDupwindNthAnti1B2 - PDupwindNthAnti1Xt2) 
    ...
    CCTK_REAL B3rhsL = (beta1L*(PDupwindNthAnti1B3 - PDupwindNthAnti1Xt3) 

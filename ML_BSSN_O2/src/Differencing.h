...
#define PDdissipationNth1(u,i,j,k) (p1o16dx*(6*(u)[index+di*(0)+dj*(0)+dk*(0)] - 4*((u)[index+di*(-1)+dj*(0)+dk*(0)] + (u)[index+di*(1)+dj*(0)+dk*(0)]) + (u)[index+di*(-2)+dj*(0)+dk*(0)] + (u)[index+di*(2)+dj*(0)+dk*(0)]))
#define PDdissipationNth2(u,i,j,k) (p1o16dy*(6*(u)[index+di*(0)+dj*(0)+dk*(0)] - 4*((u)[index+di*(0)+dj*(-1)+dk*(0)] + (u)[index+di*(0)+dj*(1)+dk*(0)]) + (u)[index+di*(0)+dj*(-2)+dk*(0)] + (u)[index+di*(0)+dj*(2)+dk*(0)]))
#define PDdissipationNth3(u,i,j,k) (p1o16dz*(6*(u)[index+di*(0)+dj*(0)+dk*(0)] - 4*((u)[index+di*(0)+dj*(0)+dk*(-1)] + (u)[index+di*(0)+dj*(0)+dk*(1)]) + (u)[index+di*(0)+dj*(0)+dk*(-2)] + (u)[index+di*(0)+dj*(0)+dk*(2)]))
...
#define PDupwindNthAnti1(u,i,j,k) (p1o4dx*(-4*(u)[index+di*(-1)+dj*(0)+dk*(0)] + 4*(u)[index+di*(1)+dj*(0)+dk*(0)] + (u)[index+di*(-2)+dj*(0)+dk*(0)] - (u)[index+di*(2)+dj*(0)+dk*(0)]))
#define PDupwindNthSymm1(u,i,j,k) (pm1o4dx*(6*(u)[index+di*(0)+dj*(0)+dk*(0)] - 4*((u)[index+di*(-1)+dj*(0)+dk*(0)] + (u)[index+di*(1)+dj*(0)+dk*(0)]) + (u)[index+di*(-2)+dj*(0)+dk*(0)] + (u)[index+di*(2)+dj*(0)+dk*(0)]))
#define PDupwindNthAnti2(u,i,j,k) (p1o4dy*(-4*(u)[index+di*(0)+dj*(-1)+dk*(0)] + 4*(u)[index+di*(0)+dj*(1)+dk*(0)] + (u)[index+di*(0)+dj*(-2)+dk*(0)] - (u)[index+di*(0)+dj*(2)+dk*(0)]))
#define PDupwindNthSymm2(u,i,j,k) (pm1o4dy*(6*(u)[index+di*(0)+dj*(0)+dk*(0)] - 4*((u)[index+di*(0)+dj*(-1)+dk*(0)] + (u)[index+di*(0)+dj*(1)+dk*(0)]) + (u)[index+di*(0)+dj*(-2)+dk*(0)] + (u)[index+di*(0)+dj*(2)+dk*(0)]))
#define PDupwindNthAnti3(u,i,j,k) (p1o4dz*(-4*(u)[index+di*(0)+dj*(0)+dk*(-1)] + 4*(u)[index+di*(0)+dj*(0)+dk*(1)] + (u)[index+di*(0)+dj*(0)+dk*(-2)] - (u)[index+di*(0)+dj*(0)+dk*(2)]))
#define PDupwindNthSymm3(u,i,j,k) (pm1o4dz*(6*(u)[index+di*(0)+dj*(0)+dk*(0)] - 4*((u)[index+di*(0)+dj*(0)+dk*(-1)] + (u)[index+di*(0)+dj*(0)+dk*(1)]) + (u)[index+di*(0)+dj*(0)+dk*(-2)] + (u)[index+di*(0)+dj*(0)+dk*(2)]))

...
/*@@
 * @file    CaKernel__gpu_cuda__3dblock__ML_BSSN_Advect.h
 * @date    Thu Feb 02 02:59:28 CST 2012
...
#ifndef CAKERNEL__GPU_CUDA__3DBLOCK__ML_BSSN_ADVECT_H
#define CAKERNEL__GPU_CUDA__3DBLOCK__ML_BSSN_ADVECT_H
#include <algorithm>
#include "cctk.h"
...
#define LapseAdvectionCoeff (+*((CCTK_REAL *) &pars_ptr[LapseAdvectionCoeff_offset]))
#define ShiftBCoeff (+*((CCTK_REAL *) &pars_ptr[ShiftBCoeff_offset]))
#define LapseACoeff (+*((CCTK_REAL *) &pars_ptr[LapseACoeff_offset]))
#define ShiftAdvectionCoeff (+*((CCTK_REAL *) &pars_ptr[ShiftAdvectionCoeff_offset]))
...
/// !!!!!!!!!!!!!!!!!!!!!!!!! BEGIN ML_BSSN_Advect Kernel macors !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
#define CAKERNEL_GFINDEX3D_ML_BSSN_Advect(ptr, i, j, k)                        \
 ptr[(i + gi) + params.cagh_ni * ((j + gj) + params.cagh_nj * (k + gk))]

#define CAKERNEL_GFINDEX3DV_ML_BSSN_Advect(ptr, i, j, k, vind)                 \
 CAKERNEL_GFINDEX3D_ML_BSSN_Advect((&ptr[vind * vstride]), i, j, k)

#define I3DV CAKERNEL_GFINDEX3DV_ML_BSSN_Advect
#define I3D CAKERNEL_GFINDEX3D_ML_BSSN_Advect

   
/** Element  */
#define CAKERNEL_GFINDEX3D_ML_BSSN_Advect_l(ptr, i, j, k)                      \
  (ptr##_sh[k + lk][j + lj][i + li])

#define CAKERNEL_GFINDEX3DV_ML_BSSN_Advect_l(ptr, i, j, k, vind)               \
  (ptr##_sh[vind][k + lk][j + lj][i + li])

#define I3D_l CAKERNEL_GFINDEX3D_ML_BSSN_Advect_l
#define I3DV_l CAKERNEL_GFINDEX3DV_ML_BSSN_Advect_l
 


#define CAKERNEL_ML_BSSN_Advect_Declare_Begin_s                                \
template<class params_type>                                                    \
__global__ void CAKERNEL_ML_BSSN_Advect(                                       \
                                                                               \
                                                                               \
 CCTK_REAL * A, CCTK_REAL * alpha, CCTK_REAL * alpharhs, CCTK_REAL * Arhs, CCTK_REAL * At11, CCTK_REAL * At11rhs, CCTK_REAL * At12, CCTK_REAL * At12rhs, CCTK_REAL * At13, CCTK_REAL * At13rhs, CCTK_REAL * At22, CCTK_REAL * At22rhs, CCTK_REAL * At23, CCTK_REAL * At23rhs, CCTK_REAL * At33, CCTK_REAL * At33rhs, CCTK_REAL * B1, CCTK_REAL * B1rhs, CCTK_REAL * B2, CCTK_REAL * B2rhs, CCTK_REAL * B3, CCTK_REAL * B3rhs, CCTK_REAL * beta1, CCTK_REAL * beta1rhs, CCTK_REAL * beta2, CCTK_REAL * beta2rhs, CCTK_REAL * beta3, CCTK_REAL * beta3rhs, CCTK_REAL * gt11, CCTK_REAL * gt11rhs, CCTK_REAL * gt12, CCTK_REAL * gt12rhs, CCTK_REAL * gt13, CCTK_REAL * gt13rhs, CCTK_REAL * gt22, CCTK_REAL * gt22rhs, CCTK_REAL * gt23, CCTK_REAL * gt23rhs, CCTK_REAL * gt33, CCTK_REAL * gt33rhs, CCTK_REAL * phi, CCTK_REAL * phirhs, CCTK_REAL * trK, CCTK_REAL * trKrhs, CCTK_REAL * Xt1, CCTK_REAL * Xt1rhs, CCTK_REAL * Xt2, CCTK_REAL * Xt2rhs, CCTK_REAL * Xt3, CCTK_REAL * Xt3rhs,\
                                                                               ...
                                                                               \
const  char * pars_ptr,                                                        \
const unsigned int LapseAdvectionCoeff_offset, const unsigned int ShiftBCoeff_offset, const unsigned int LapseACoeff_offset, const unsigned int ShiftAdvectionCoeff_offset,\
                                                                               \
/** Statically added variables to each kernel: */                              \
const params_type params)                                                      \
{                                                                           
# define CAKERNEL_ML_BSSN_Advect_Declare_Cached_Variables_s                    \
...
# define CAKERNEL_ML_BSSN_Advect_Declare_Flow_Variables_s                      \
  int li = threadIdx.x;                                                        \
  int lj = threadIdx.y;                                                        \
...
# define CAKERNEL_ML_BSSN_Advect_Limit_Threads_To_LSH_Begin_s                  \
  if(fetch_data)                                                               \
  {                                                                           
#   define CAKERNEL_ML_BSSN_Advect_Fetch_Data_To_Cache_s                       \
                                                                               \
                                                                               \
                                                                               \
                                                                               \
...
#   define CAKERNEL_ML_BSSN_Advect_Computations_Begin_s                        \
    for ( short tmpj = 0; tmpj < tilez_to; tmpj++)                             \
    {                                                                          \
      SYNC_BLOCK();                                                          
#     define CAKERNEL_ML_BSSN_Advect_Iterate_Local_Tile_s                      \
                                                                               \
                                                                               \
                                                                               \
                                                                               \
...
#     define CAKERNEL_ML_BSSN_Advect_Fetch_Front_Tile_To_Cache_s               \
                                                                               \
                                                                               \
      SYNC_BLOCK();                                                      

#     define CAKERNEL_ML_BSSN_Advect_Limit_Threads_To_Compute_Begin_s          \
      if(compute)                                                              \
      {                                                                        \
...
#     define CAKERNEL_ML_BSSN_Advect_Limit_Threads_To_Compute_End_s            \
      }                                                                      
#   define CAKERNEL_ML_BSSN_Advect_Computations_End_s                          \
    }                                                                        
# define CAKERNEL_ML_BSSN_Advect_Limit_Threads_To_LSH_End_s                    \
  }                                                                          
#define CAKERNEL_ML_BSSN_Advect_Declare_End_s                                  \
}

#define CAKERNEL_ML_BSSN_Advect_Begin                                          \
CAKERNEL_ML_BSSN_Advect_Declare_Begin_s                                        \
  CAKERNEL_ML_BSSN_Advect_Declare_Cached_Variables_s                           \
  CAKERNEL_ML_BSSN_Advect_Declare_Flow_Variables_s                             \
  CAKERNEL_ML_BSSN_Advect_Limit_Threads_To_LSH_Begin_s                         \
    CAKERNEL_ML_BSSN_Advect_Fetch_Data_To_Cache_s                                   
                                                                              
#   define CAKERNEL_ML_BSSN_Advect_Computations_Begin                          \
    CAKERNEL_ML_BSSN_Advect_Computations_Begin_s                               \
      CAKERNEL_ML_BSSN_Advect_Iterate_Local_Tile_s                             \
      CAKERNEL_ML_BSSN_Advect_Fetch_Front_Tile_To_Cache_s                      \
      CAKERNEL_ML_BSSN_Advect_Limit_Threads_To_Compute_Begin_s                      
                                                                              
#   define CAKERNEL_ML_BSSN_Advect_Computations_End                            \
      CAKERNEL_ML_BSSN_Advect_Limit_Threads_To_Compute_End_s                   \
    CAKERNEL_ML_BSSN_Advect_Computations_End_s                                 \
  CAKERNEL_ML_BSSN_Advect_Limit_Threads_To_LSH_End_s                    
                                                                            
#define CAKERNEL_ML_BSSN_Advect_End                                            \
CAKERNEL_ML_BSSN_Advect_Declare_End_s


/// !!!!!!!!!!!!!!!!!!!!!!!!! END ML_BSSN_Advect Kernel macors !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!

#endif

#endif /* CAKERNEL__GPU_CUDA__3DBLOCK__ML_BSSN_ADVECT_H */

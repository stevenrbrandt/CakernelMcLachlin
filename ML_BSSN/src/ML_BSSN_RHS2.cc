...
static void ML_BSSN_RHS2_Body(cGH const * restrict const cctkGH, int const dir, int const face, CCTK_REAL const normal[3], CCTK_REAL const tangentA[3], CCTK_REAL const tangentB[3], int const min[3], int const max[3], int const n_subblock_gfs, CCTK_REAL * restrict const subblock_gfs[])
{
            ...
            cctk_lsh[0],cctk_lsh[1],cctk_lsh[2])
  {
    ...
    CCTK_REAL_VEC Rt33 = 4*(Gt123*gt13L*Gt323*gtu22 + 
      ...
      Gt113*gt13L*Xtn1 + Gt213*gt23L*Xtn1 + Gt313*gt33L*Xtn1 + 
      Gt123*gt13L*Xtn2 + Gt223*gt23L*Xtn2 + Gt323*gt33L*Xtn2 + 
      Gt133*gt13L*Xtn3 + Gt333*gt33L*Xtn3 + Gt233*(4*gt23L*Gt333*gtu33 + 
      2*Gt323*gt33L*gtu33 + gt23L*Xtn3) + gtu11*(2*Gt212*Gt213*gt23L + 
    ...
    CCTK_REAL_VEC At11rhsL = -2.*alphaL*(At11L*Atm11 + At12L*Atm21 + 
    ...
    CCTK_REAL_VEC At12rhsL = -2.*alphaL*(At11L*Atm12 + At12L*Atm22 + 
    ...
    CCTK_REAL_VEC At13rhsL = -2.*alphaL*(At11L*Atm13 + At12L*Atm23 + 
    ...
    CCTK_REAL_VEC At22rhsL = -2.*alphaL*(At12L*Atm12 + At22L*Atm22 + 
    ...
    CCTK_REAL_VEC At23rhsL = -2.*alphaL*(At12L*Atm13 + At22L*Atm23 + 
    ...
    CCTK_REAL_VEC At33rhsL = -2.*alphaL*(At13L*Atm13 + At23L*Atm23 + 

...
static void HOST_ML_BSSN_convertToADMBase_Body(const cGH* restrict const cctkGH, const int dir, const int face, const CCTK_REAL normal[3], const CCTK_REAL tangentA[3], const CCTK_REAL tangentB[3], const int imin[3], const int imax[3], const int n_subblock_gfs, CCTK_REAL* restrict const subblock_gfs[])
{
    ...
    cctk_ash[0],cctk_ash[1],cctk_ash[2])
  {
    ...
    CCTK_REAL gxxL CCTK_ATTRIBUTE_UNUSED = gt11L*e4phi;
    
    CCTK_REAL gxyL CCTK_ATTRIBUTE_UNUSED = gt12L*e4phi;
    
    CCTK_REAL gxzL CCTK_ATTRIBUTE_UNUSED = gt13L*e4phi;
    
    CCTK_REAL gyyL CCTK_ATTRIBUTE_UNUSED = gt22L*e4phi;
    
    CCTK_REAL gyzL CCTK_ATTRIBUTE_UNUSED = gt23L*e4phi;
    
    CCTK_REAL gzzL CCTK_ATTRIBUTE_UNUSED = gt33L*e4phi;

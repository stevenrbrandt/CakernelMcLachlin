#include"CaKernel__gpu_cuda__3dblock__ML_BSSN_RHS1.h"
#include"CaKernel__ML_BSSN_RHS1.code"
...
void CAKERNEL_Launch_ML_BSSN_RHS1(CCTK_ARGUMENTS)
{
    ...
    if ( CAKERNEL_Tile##d <= stncl_##d##n + stncl_##d##p )                     \
      CCTK_VWarn                                                               \
       (CCTK_WARN_ABORT, __LINE__,__FILE__, CCTK_THORNSTRING,                  \
        "Tile size for ML_BSSN_RHS1 along %s axis (%d) too small for stencil %d -- %d\n",\

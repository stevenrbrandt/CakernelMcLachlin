...
static void ML_BSSN_UPW_RHS1_Body(cGH const * restrict const cctkGH, int const dir, int const face, CCTK_REAL const normal[3], CCTK_REAL const tangentA[3], CCTK_REAL const tangentB[3], int const min[3], int const max[3], int const n_subblock_gfs, CCTK_REAL * restrict const subblock_gfs[])
{
    ...
    cctk_lsh[0],cctk_lsh[1],cctk_lsh[2])
  {
    ...
    CCTK_REAL phirhsL = PDupwindNth1(&phi[index])*beta1L + 
    ...
    CCTK_REAL gt11rhsL = -2*alphaL*At11L + 
      ...
      PDupwindNth3(&gt11[index])*beta3L + epsdiss1*PDdissipationNth1gt11 + 
    ...
    CCTK_REAL gt12rhsL = -2*alphaL*At12L + 
      PDupwindNth1(&gt12[index])*beta1L + 
      PDupwindNth2(&gt12[index])*beta2L + 
      PDupwindNth3(&gt12[index])*beta3L + epsdiss1*PDdissipationNth1gt12 + 
    ...
    CCTK_REAL gt13rhsL = -2*alphaL*At13L + 
      PDupwindNth1(&gt13[index])*beta1L + 
      PDupwindNth2(&gt13[index])*beta2L + 
      PDupwindNth3(&gt13[index])*beta3L + epsdiss1*PDdissipationNth1gt13 + 
    ...
    CCTK_REAL gt22rhsL = -2*alphaL*At22L + 
      PDupwindNth1(&gt22[index])*beta1L + 
      PDupwindNth2(&gt22[index])*beta2L + 
      PDupwindNth3(&gt22[index])*beta3L + epsdiss1*PDdissipationNth1gt22 + 
    ...
    CCTK_REAL gt23rhsL = -2*alphaL*At23L + 
      PDupwindNth1(&gt23[index])*beta1L + 
      PDupwindNth2(&gt23[index])*beta2L + 
      PDupwindNth3(&gt23[index])*beta3L + epsdiss1*PDdissipationNth1gt23 + 
    ...
    CCTK_REAL gt33rhsL = -2*alphaL*At33L + 
      PDupwindNth1(&gt33[index])*beta1L + 
      PDupwindNth2(&gt33[index])*beta2L + 
      PDupwindNth3(&gt33[index])*beta3L + epsdiss1*PDdissipationNth1gt33 + 
    ...
    CCTK_REAL ArhsL = epsdiss1*PDdissipationNth1A + 
      ...
      (PDupwindNth1(&A[index])*beta1L + PDupwindNth2(&A[index])*beta2L + 
    ...
    CCTK_REAL B1rhsL = epsdiss1*PDdissipationNth1B1 + 
      ...
      ((PDupwindNth1(&B1[index]) - PDupwindNth1(&Xt1[index]))*beta1L + 
      (PDupwindNth2(&B1[index]) - PDupwindNth2(&Xt1[index]))*beta2L + 
      (PDupwindNth3(&B1[index]) - 
    ...
    CCTK_REAL B2rhsL = epsdiss1*PDdissipationNth1B2 + 
      ...
      ((PDupwindNth1(&B2[index]) - PDupwindNth1(&Xt2[index]))*beta1L + 
      (PDupwindNth2(&B2[index]) - PDupwindNth2(&Xt2[index]))*beta2L + 
      (PDupwindNth3(&B2[index]) - 
    ...
    CCTK_REAL B3rhsL = epsdiss1*PDdissipationNth1B3 + 
      ...
      ((PDupwindNth1(&B3[index]) - PDupwindNth1(&Xt3[index]))*beta1L + 
      (PDupwindNth2(&B3[index]) - PDupwindNth2(&Xt3[index]))*beta2L + 
      (PDupwindNth3(&B3[index]) - 

...
void ML_BSSN_UPW_RHS2_SelectBCs(CCTK_ARGUMENTS)
{
...
void ML_BSSN_UPW_RHS2_Body(cGH const * restrict const cctkGH, int const dir, int const face, CCTK_REAL const normal[3], CCTK_REAL const tangentA[3], CCTK_REAL const tangentB[3], int const min[3], int const max[3], int const n_subblock_gfs, CCTK_REAL * restrict const subblock_gfs[])
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
            ...
            cctk_lsh[0],cctk_lsh[1],cctk_lsh[2])
  {
    ...
    CCTK_REAL At11rhsL = -2.*alphaL*(At11L*Atm11 + At12L*Atm21 + 
      ...
      k)*beta3L + epsdiss1*PDdissipationNth1At11 + 
    ...
    CCTK_REAL At12rhsL = -2.*alphaL*(At11L*Atm12 + At12L*Atm22 + 
      ...
      k)*beta3L + epsdiss1*PDdissipationNth1At12 + 
    ...
    CCTK_REAL At13rhsL = -2.*alphaL*(At11L*Atm13 + At12L*Atm23 + 
      ...
      k)*beta3L + epsdiss1*PDdissipationNth1At13 + 
    ...
    CCTK_REAL At22rhsL = -2.*alphaL*(At12L*Atm12 + At22L*Atm22 + 
      ...
      k)*beta3L + epsdiss1*PDdissipationNth1At22 + 
    ...
    CCTK_REAL At23rhsL = -2.*alphaL*(At12L*Atm13 + At22L*Atm23 + 
      ...
      k)*beta3L + epsdiss1*PDdissipationNth1At23 + 
    ...
    CCTK_REAL At33rhsL = -2.*alphaL*(At13L*Atm13 + At23L*Atm23 + 
      ...
      k)*beta3L + epsdiss1*PDdissipationNth1At33 + 
...
void ML_BSSN_UPW_RHS2(CCTK_ARGUMENTS)
{
  DECLARE_CCTK_ARGUMENTS;
  DECLARE_CCTK_PARAMETERS;
